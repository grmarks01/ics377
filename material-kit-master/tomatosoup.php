  ...
  <div class="section">
    ...
    <div class="instruction-list">
      <div class="instruction-item">
        ...
        <div class="step-text">Heat olive oil in a large pot over medium heat. Add diced onion and cook for 5 minutes until softened and translucent.</div>
      </div>
      <div class="instruction-item">
        <div class="step-number">2</div>
        <div class="step-text">Add minced garlic and cook for another 30 seconds until fragrant.</div>
      </div>
      <div class="instruction-item">
        <div class="step-number">3</div>
        <div class="step-text">Add the diced tomatoes and vegetable broth. Stir in sugar, salt, and pepper. Bring to a boil.</div>
      </div>
      <div class="instruction-item">
        <div class="step-number">4</div>
        <div class="step-text">Reduce heat and simmer for 15 minutes, stirring occasionally, until tomatoes have fully broken down.</div>
      </div>
      <div class="instruction-item">
        <div class="step-number">5</div>
        <div class="step-text">Use an immersion blender to blend the soup smooth directly in the pot. Alternatively, transfer in batches to a blender.</div>
      </div>
      <div class="instruction-item">
        <div class="step-number">6</div>
        <div class="step-text">Taste and adjust seasoning. Serve hot, garnished with fresh basil. Great with crusty bread on the side.</div>
      </div>
    </div>
  </div>
...
<script>
  const INGREDIENTS = [
    { text: '6 large tomatoes, diced',      key: 'tomato' },
    { text: '1 medium onion, diced',         key: 'onion' },
    { text: '3 cloves garlic, minced',       key: 'garlic' },
    { text: '2 tbsp olive oil',              key: 'olive oil' },
    { text: '1 cup vegetable broth',         key: 'broth' },
    { text: '1 tsp sugar',                   key: 'sugar' },
    { text: 'Salt and pepper to taste',      key: 'salt' },
    { text: 'Fresh basil to garnish',        key: 'basil' },
  ];
  ...
  function addToPlan() {
    window.location.href = 'myplan.php?add=Tomato Soup';
  }
</script>
